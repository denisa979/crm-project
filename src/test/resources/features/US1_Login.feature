...
Feature: Login functionalities.
  ...
  Background:User is already on the login page
    ...
    Scenario Outline: Verify that <userType> user can log in with valid credentials and land on the home page.
      ...
      Scenario Outline: Verify that "Incorrect login or password" error message is displayed for invalid credentials.
        When user logged in withe username as "username>" and password as "<password>"
